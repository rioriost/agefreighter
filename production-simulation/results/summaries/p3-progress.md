...
After another complete guardrail check, the Neo4j 4.4 container was restarted
at 2026-09-02T21:35:59Z. Segment 2 failed as expected at 21:36:00Z with
229,300,000 committed rows (40.95%), zero rejects, next batch 11,466, and the
same graph generation and configuration fingerprint. The source container
returned at 21:36:06Z and was proven online and read-only; its start timestamp
changed, it was not OOM-killed, and source disk, swap, and OOM remained within
their gates. Source-side restart evidence and a SHA-256 manifest are retained,
as are the loader-side failed job row and error evidence.

Segment 3 started at 2026-09-02T21:39:58Z with target preparation disabled,
the same reviewed discovery snapshot, and durable job
`d727d9aa-b7e5-4728-9254-90bd0210406d`. At 21:40:44Z it was active against
...
The full digest completed at 2026-09-03T02:35:08Z with exit status zero after
1:58:09. It covered all 560,000,000 rows in 5,600 leaves; every range and the
final root matched both the fixture and accepted clean root
`0302c456d17c6e9ee64552d68e2bf6a775e63cd3b09120f5bc342d329bddd1ba`.
Maximum observed digest RSS was 2,637,820 KiB with zero swap/OOM. The Neo4j
4.4 recovery qualification is complete.
...
The Neo4j 4.4 VM was deallocated and the Neo4j 5.26 VM started. At
2026-09-03T02:47:37Z the source proved Community 5.26.30, an online read-only
database, 48 GiB initial/maximum heap, 28 GiB page cache, 20 online indexes,
32% data-disk use, and zero swap/OOM. Fresh segment
