...
| required-metadata-indexes | pass | version-compatible agefreighter metadata indexes were inspected | invalid\_or\_missing\_indexes=0 missing\_relations=0 schema\_version=20 |
...
| metadataInstalledVersion | 20 | pass |
| metadataSupportedVersion | 20 | pass |
