...
| required-metadata-indexes | pass | version-compatible agefreighter metadata indexes were inspected | invalid\_or\_missing\_indexes=0 missing\_relations=0 schema\_version=18 |
...
| metadataInstalledVersion | 18 | pass |
| metadataSupportedVersion | 18 | pass |
